...
`change 001-spec-purify` (archive/changes/2026-05-16-001-spec-purify/、R-17 lifecycle 完遂で archive 移動済) で **案 F (clean architecture)** を採用、以下を確立する:
...
- `architecture/archive/changes/2026-05-16-001-spec-purify/` — 本 ADR を反映する change package (proposal/design/tasks/spec-delta、R-17 lifecycle 完遂で archive 移動済)
