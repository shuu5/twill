...
# Generated from: deltaspec/changes/archive/2026-03-31-session-audit-verification/specs/controller-verification/spec.md
...
test_issue_44_report_structure_spec_exists() {
  ...
  local spec="deltaspec/changes/archive/2026-03-31-session-audit-verification/specs/controller-verification/spec.md"
