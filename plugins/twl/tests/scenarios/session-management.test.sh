...
# Generated from: deltaspec/changes/archive/2026-03-27-b-3-autopilot-state-management/specs/session-management.md
...
" 2>/dev/null || return 1
    ...
    local spec_file="${PROJECT_ROOT}/deltaspec/changes/archive/2026-03-27-b-3-autopilot-state-management/specs/session-management.md"
