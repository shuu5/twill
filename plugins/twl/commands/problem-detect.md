...
|---------|----------|----------|
| `Error:` | medium | general-error |
| `APIError:` | high | api-error |
| `MergeGateError:` | high | merge-gate-failure |
| `failed to` | medium | general-failure |
| `\[CRITICAL\]` | critical | critical-level |
| `nudge sent` | low | worker-stall |
| `silent.*deletion` | high | silent-deletion |
| `AC.*矮小化\|矮小化` | high | ac-diminishment |
| `force.with.lease` | medium | pilot-rebase-intervention |
