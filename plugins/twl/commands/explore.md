...
**Input**: The argument after `/twl:explore` is whatever the user wants to think about. Could be:
...
You have full context of the delta spec system. Use it naturally, don't force it.
...
- **Don't implement** - Never write code or implement features. Creating DeltaSpec artifacts is fine, writing application code is not.
