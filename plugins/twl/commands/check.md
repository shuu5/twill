...
| 項目 | 状態 | 詳細 |
|------|------|------|
| DeltaSpec | PASS/WARN/FAIL/N/A | proposal.md状況 |
...
| 項目 | FAIL理由 | 対応 |
|------|---------|------|
| DeltaSpec | proposal未作成 | `/twl:change-propose` を実行 |
| DeltaSpec | proposal未承認 | 「承認してください」と待機 |
