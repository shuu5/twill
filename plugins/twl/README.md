...
| twl:su-observer | observe-once, problem-detect, ●observer-evaluator, intervene-auto, intervene-confirm, intervene-escalate, →twl:intervention-catalog, →twl:observation-pattern-catalog, →twl:monitor-channel-catalog, su-compact, wave-collect, externalize-state, →twl:pitfalls-catalog, →twl:proxy-dialog-playbook, →twl:ref-invariants, →twl:su-observer-supervise-channels, →twl:su-observer-controller-spawn-playbook, →twl:su-observer-wave-management, →twl:su-observer-security-gate |
