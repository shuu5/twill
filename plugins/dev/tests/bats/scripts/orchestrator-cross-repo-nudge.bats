...
GH_EOF
  ...
  assert_success
  assert_output "/dev:workflow-test-ready #202"
}
...
GH_EOF
  ...
  assert_success
  assert_output "/dev:workflow-test-ready #55"
...
GH_EOF
  ...
  assert_success
  assert_output "/dev:workflow-pr-cycle #77"
...
GH_EOF
  ...
  assert_success
  assert_output "/dev:workflow-test-ready #88"
...
GH_EOF
  ...
  assert_success
  assert_output "/dev:workflow-test-ready #301"
...
@test "nudge-cross: legacy dispatch patterns still work after cross-repo extension" {
  ...
  assert_success
  assert_output "/dev:workflow-test-ready #999"
}
