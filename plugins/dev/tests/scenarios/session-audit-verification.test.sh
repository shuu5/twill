...
# Generated from: openspec/changes/session-audit-verification/specs/controller-verification/spec.md
...
test_issue_44_report_structure_spec_exists() {
  ...
  local spec="openspec/changes/session-audit-verification/specs/controller-verification/spec.md"
