# /dev:issue-create - GitHub Issue作成
...
```
/dev:issue-create "タイトル" "本文"
/dev:issue-create "タイトル" "本文" --label enhancement --related #45 --parent #123
```
...
単独実行の場合: → `/dev:workflow-setup` で `#N` から開発開始
