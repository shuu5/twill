...
class TestAllTestsPassAfterSplit:
    ...
    def test_no_tests_lost_in_split(self) -> None:
        ...
        expected_test_names = {
            ...
            "test_scope_direct_label_skips_check_when_checkpoint_missing",
            "test_quick_label_skips_check_when_checkpoint_missing",
            "test_scope_direct_label_also_skips_critical_findings_check",
            "test_quick_label_also_skips_critical_findings_check",
            "test_unrelated_label_does_not_skip_check",
            "test_multiple_labels_including_quick_skips_check",
