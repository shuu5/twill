...
- `loom chain generate <chain-name>` サブコマンドを loom-engine.py に追加
...
- **chain-generate-stdout**: `loom chain generate <chain-name>` で Template A/B/C を stdout に出力
...
- **変更対象**: `loom-engine.py`（CLI 引数追加、テンプレート生成関数追加）
