#!/usr/bin/env bats
# EXP-038: forbidden 語 word boundary 検出 + false positive 抑制
#
...
@test "vocabulary-audit: 偽陽性抑制 - compound canonical 'co-autopilot' 内の pilot は除外" {
    local fix="${SANDBOX}/negative-compound.md"
